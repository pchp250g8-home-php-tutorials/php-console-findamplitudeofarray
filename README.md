...
FindAmplitudeOfArray. Занятия по PHP. Простой Ввод/вывод. Массивы. Алгоритмы. Консольное приложение.
...
4. Вводятся переменные для индекса максимального и минимального элемента массива и их значений. Индексы элементов равны 0,
   а значения - значению первого (нулевого) элемента массива.
